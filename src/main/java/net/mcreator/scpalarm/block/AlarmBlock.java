...
import net.mcreator.scpalarm.procedures.AsoundplayProcedure;
import net.mcreator.scpalarm.procedures.AselectoropenProcedure;
...
public class AlarmBlock extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:alarm")
	public static final Block block = null;
	@ObjectHolder("more_scp_alarm:alarm")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public AlarmBlock(MoreScpAlarmModElements instance) {
		super(instance, 32);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("alarm"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				AsoundplayProcedure.executeProcedure(Stream
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			AselectoropenProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("alarm");
		}
