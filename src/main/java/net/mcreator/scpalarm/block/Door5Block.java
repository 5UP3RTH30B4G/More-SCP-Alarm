...
public class Door5Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:door_5")
	public static final Block block = null;

	public Door5Block(MoreScpAlarmModElements instance) {
		super(instance, 17);
	}
