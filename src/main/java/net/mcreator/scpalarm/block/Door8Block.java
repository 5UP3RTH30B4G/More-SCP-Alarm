...
public class Door8Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:door_8")
	public static final Block block = null;

	public Door8Block(MoreScpAlarmModElements instance) {
		super(instance, 20);
	}
