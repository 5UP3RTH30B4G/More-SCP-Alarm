...
public class Gate1Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:gate_1")
	public static final Block block = null;

	public Gate1Block(MoreScpAlarmModElements instance) {
		super(instance, 13);
	}
