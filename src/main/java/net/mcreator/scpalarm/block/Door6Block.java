...
public class Door6Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:door_6")
	public static final Block block = null;

	public Door6Block(MoreScpAlarmModElements instance) {
		super(instance, 18);
	}
