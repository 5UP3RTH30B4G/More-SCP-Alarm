...
import net.mcreator.scpalarm.procedures.G2Procedure;
...
public class GeneratorBlock extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:generatoron")
	public static final Block block = null;
	@ObjectHolder("more_scp_alarm:generatoron")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public GeneratorBlock(MoreScpAlarmModElements instance) {
		super(instance, 22);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("generatoron"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			G2Procedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("generatoron");
		}
