...
public class DoorFrameBlock extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:door_frame")
	public static final Block block = null;

	public DoorFrameBlock(MoreScpAlarmModElements instance) {
		super(instance, 21);
	}
