...
import net.mcreator.scpalarm.procedures.LightgooffProcedure;
...
public class TvlightBlock extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:tvlight")
	public static final Block block = null;

	public TvlightBlock(MoreScpAlarmModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				LightgooffProcedure.executeProcedure(Stream
