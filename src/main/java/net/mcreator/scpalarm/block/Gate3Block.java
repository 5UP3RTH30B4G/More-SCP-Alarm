...
public class Gate3Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:gate_3")
	public static final Block block = null;

	public Gate3Block(MoreScpAlarmModElements instance) {
		super(instance, 15);
	}
