...
public class Gate2Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:gate_2")
	public static final Block block = null;

	public Gate2Block(MoreScpAlarmModElements instance) {
		super(instance, 14);
	}
