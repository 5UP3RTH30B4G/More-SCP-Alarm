...
import net.mcreator.scpalarm.procedures.Ptv895offProcedure;
...
public class Tv895Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:tv_895")
	public static final Block block = null;

	public Tv895Block(MoreScpAlarmModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				Ptv895offProcedure.executeProcedure(Stream
