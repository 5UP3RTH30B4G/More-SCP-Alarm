...
public class Gate4Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:gate_4")
	public static final Block block = null;

	public Gate4Block(MoreScpAlarmModElements instance) {
		super(instance, 16);
	}
