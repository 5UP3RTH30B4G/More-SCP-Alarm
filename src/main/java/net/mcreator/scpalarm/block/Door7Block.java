...
public class Door7Block extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:door_7")
	public static final Block block = null;

	public Door7Block(MoreScpAlarmModElements instance) {
		super(instance, 19);
	}
