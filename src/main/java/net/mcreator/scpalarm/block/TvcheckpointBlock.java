...
import net.mcreator.scpalarm.procedures.TvgooffProcedure;
...
public class TvcheckpointBlock extends MoreScpAlarmModElements.ModElement {
	@ObjectHolder("more_scp_alarm:tvcheckpoint")
	public static final Block block = null;

	public TvcheckpointBlock(MoreScpAlarmModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				TvgooffProcedure.executeProcedure(Stream
