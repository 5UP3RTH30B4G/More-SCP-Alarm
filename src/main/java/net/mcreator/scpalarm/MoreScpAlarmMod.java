 ...
 *
 *    Keep the MoreScpAlarmModElements object in this class and all calls to this object
...
public class MoreScpAlarmMod {
	...
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation("more_scp_alarm", "more_scp_alarm"),
	...
	private static class MoreScpAlarmModFMLBusEvents {
		private final MoreScpAlarmMod parent;

		MoreScpAlarmModFMLBusEvents(MoreScpAlarmMod parent) {
			this.parent = parent;
		}
